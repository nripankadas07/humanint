        ...
        humanint exists to solve a narrow, inspectable developer-tooling problem:
        Parse and format human-readable integers (1.5k, 2M, 3.2B). Zero dependencies.
        ...
        Topics: formatter, human-readable, number-formatting, parser, python, zero-dependencies
